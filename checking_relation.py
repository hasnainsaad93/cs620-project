...
for year in years:
    ...
    # yearly_high_temp = yearly_data.iloc[:,4]
    # yearly_low_temp = yearly_data.iloc[:,5]
    # yearly_avg_temp = yearly_data.iloc[:,6]
    # yearly_precipitation = yearly_data.iloc[:,7]
    # yearly_dew_point = yearly_data.iloc[:,8]
    # yearly_high_dew_point = yearly_data.iloc[:,9]
    # yearly_low_dew_point = yearly_data.iloc[:,10]
    # yearly_avg_dew_point = yearly_data.iloc[:,11]
    # yearly_max_wind_speed = yearly_data.iloc[:,12]
    # yearly_month_visibility = yearly_data.iloc[:,13]
    # yearly_sea_pressure = yearly_data.iloc[:,14]
...
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_high_temp', ax=axs[0][0])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_dew_point', ax=axs[0][1])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_precipitation', ax=axs[0][2])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_max_wind_speed', ax=axs[1][0])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_sea_pressure', ax=axs[1][1])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_visibility', ax=axs[1][2])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_low_temp', ax=axs[2][0])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_avg_temp', ax=axs[2][1])
sns.scatterplot(data=relational_data, x='production_cwt', y='mean_high_dew_point', ax=axs[2][2])
